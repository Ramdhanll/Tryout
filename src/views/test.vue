<template>
  <div>
    <div class="row">
          <div class="side-left col-md-6">
            <div class="container">
              ...
              <label for="">Email</label>
                <input type="text"
                  class="form-control" name="name" aria-describedby="helpId" placeholder="Masukan Email" v-model="form_register.name" style="width: 250px">
                <small v-if="errors_register.name" id="helpId" class="form-text text-danger">{{errors_register.name[0]}}</small>
              </div>
              <div class="form-group">
              <label for="">Password</label>
                <input type="text"
                  class="form-control" name="name" aria-describedby="helpId" placeholder="Masukan Password" v-model="form_register.name" style="width: 250px">
                <small v-if="errors_register.name" id="helpId" class="form-text text-danger">{{errors_register.name[0]}}</small>
              </div>
              <button class="btn btn-primary py-2 px-5 mt-5" @click="showModalLogin()">Login</button>
              <button class="btn btn-success py-2 px-5 ml-3 mt-5 btn-register" @click="showModalRegister()" >Register</button>
      ...
      <b-modal ref="login-modal" id="modal-1" title="Form Login">
        <div class="form-group">
          <label for="">Email</label>
          <input type="email"
        ...
        <div class="form-check">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input mt-1 " name="" value="checkedValue" checked>
              Remember Me
          </label>
        </div>
